...
CREATE TABLE `login_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COMMENT='登录日志';
...
INSERT INTO `menu` VALUES ('3', '2', '3', '添加', 'userAdd', '', '', '', '/admin/User/initAdd\n/admin/User/saveAdd', '1', '1');
INSERT INTO `menu` VALUES ('4', '2', '3', '修改', 'userEdit', '', '', '', '/admin/User/initEdit\n/admin/User/saveEdit', '1', '2');
...
INSERT INTO `menu` VALUES ('7', '2', '3', '修改密码', 'userEditPassword', '', '', '', '/admin/User/editPassword', '1', '5');
INSERT INTO `menu` VALUES ('8', '5', '3', '添加', 'departmentAdd', '', '', '', '/admin/Department/initAdd\n/admin/Department/saveAdd', '1', '1');
INSERT INTO `menu` VALUES ('9', '5', '3', '修改', 'departmentEdit', '', '', '', '/admin/Department/initEdit\n/admin/Department/saveEdit', '1', '1');
INSERT INTO `menu` VALUES ('10', '5', '3', '删除', 'departmentDelete', '', '', '', '/admin/Department/delete', '1', '1');
INSERT INTO `menu` VALUES ('11', '1', '2', '角色管理', 'role', '/system/role', 'system/role/Index.vue', 'ChatSquare', '/admin/Role/getIndexRoles', '1', '3');
INSERT INTO `menu` VALUES ('12', '11', '3', '添加', 'roleAdd', '', '', '', '/admin/Role/initAdd\n/admin/Role/saveAdd', '1', '1');
INSERT INTO `menu` VALUES ('13', '11', '3', '修改', 'roleEdit', '', '', '', '/admin/Role/initEdit\n/admin/Role/saveEdit', '1', '2');
INSERT INTO `menu` VALUES ('14', '11', '3', '删除', 'roleDelete', '', '', '', '/admin/Role/delete', '1', '3');
INSERT INTO `menu` VALUES ('15', '1', '2', '菜单管理', 'menu', '/system/menu', 'system/menu/Index.vue', 'Reading', '/admin/Menu/getIndexMenus', '1', '4');
INSERT INTO `menu` VALUES ('16', '15', '3', '添加', 'menuAdd', '', '', '', '/admin/Menu/initAdd\n/admin/Menu/saveAdd', '1', '1');
INSERT INTO `menu` VALUES ('17', '15', '3', '修改', 'menuEdit', '', '', '', '/admin/Menu/initEdit\n/admin/Menu/saveEdit', '1', '2');
INSERT INTO `menu` VALUES ('18', '15', '3', '删除', 'menuDelete', '', '', '', '/admin/Menu/delete', '1', '3');
...
INSERT INTO `menu` VALUES ('20', '19', '3', '添加', 'dictionaryAdd', '', '', '', '/admin/Dictionary/saveAdd', '1', '1');
INSERT INTO `menu` VALUES ('21', '19', '3', '修改', 'dictionaryEdit', '', '', '', '/admin/Dictionary/initEdit\n/admin/Dictionary/saveEdit', '1', '2');
INSERT INTO `menu` VALUES ('22', '19', '3', '删除', 'dictionaryDelete', '', '', '', '/admin/Dictionary/delete', '1', '3');
...
INSERT INTO `menu` VALUES ('26', '2', '3', '踢下线', 'userOffLine', '', '', '', '/admin/User/offLine', '1', '5');
...
CREATE TABLE `operation_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=149 DEFAULT CHARSET=utf8mb4 COMMENT='操作日志';
...
CREATE TABLE `token` (
  ...
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=36 DEFAULT CHARSET=utf8mb4 COMMENT='token';
...
INSERT INTO `token` VALUES ('35', 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpZCI6MTAsIm5hbWUiOiJcdTViNTlcdTRlN2VcdTYyMzciLCJkZXBhcnRtZW50X2lkIjoxLCJ0aW1lIjoiMC43Njc2MzkwMCAxNjg2NjIzNjE0In0.alrwDCWBnhQGKe7x_qAzMA995123-QtHNxD1FSIO37k', '1686632245', '10');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('10', '1', '1', 'admin', 'e10adc3949ba59abbe56e057f20f883e', '管理员', '15108273576', '', '1684989244', '1685071233', '0', '');
INSERT INTO `user` VALUES ('11', '1', '1', 'user1', 'e10adc3949ba59abbe56e057f20f883e', '用户1', '18781933732', '', '1684992552', '1685065712', '0', '');
