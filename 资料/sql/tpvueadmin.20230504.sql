...
CREATE TABLE `user` (
  ...
  `last_login_ip` varchar(32) NOT NULL DEFAULT '' COMMENT '登录ip',
  PRIMARY KEY (`id`),
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('8', '1', '1', '1', '15108273576', '01286d00e524004e4ba96705a166dd38', 'fdsf', '15108273576', '', '1675929726', '0', '0', '');
